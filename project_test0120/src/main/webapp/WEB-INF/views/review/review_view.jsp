...
<%-- 			<c:set var="review_seq" value="${dto.review_seq}" /> --%>
<%-- 			<c:set var="review_like_review_seq" value="${review_like_list[status.index].review_like_review_seq}" /> --%>
								...
								<div class="comment-widgets d-flex m-b-20">
									<div class="profile column-row mt-3">
										...
										<div
											...
											<div class="bookmark">
<%-- 											<c:choose> --%>
<%-- 												<c:when test="${review_seq == review_like_review_seq}"> --%>
<!-- 												<input type="checkbox" class="btn-check" -->
<%-- 													id="review-bookmark_${dto.review_seq}" autocomplete="off" checked="checked"/> <label --%>
<%-- 													class="btn btn-bookmark" for="review-bookmark_${dto.review_seq}" onclick="review_like(this);"><i --%>
<!-- 													class="fa-solid fa-heart fa-lg"> </i> </label> -->
<%-- 												</c:when> --%>
<%-- 												<c:otherwise> --%>
												<input type="checkbox" class="btn-check"
													id="review-bookmark_${dto.review_seq}" autocomplete="off" onchange="review_like(this);"/> <label
													class="btn btn-bookmark" for="review-bookmark_${dto.review_seq}" ><i
													class="fa-solid fa-heart fa-lg"> </i> </label>
<%-- 												</c:otherwise> --%>
<%-- 											</c:choose> --%>
											</div>
